...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="card-title fw-mediumbold">Добавление поставщика оборудования</div>
                    <form action="{{route('suppliers.store')}}" class="mt-3" method="POST">
                        @csrf
                        <div class="form-group @error('title') has-error @enderror">
                            <label for="title">Наименование поставщика оборудования:</label>
                            <input type="text" class="form-control" name="title" id="title" placeholder="Введите наименование..." value="{{old('title')}}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group @error('address') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="address" id="address" placeholder="Введите юридический адрес..." value="{{old('address')}}">
                        ...
                        <div class="form-group @error('ogrnip') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="ogrnip" id="ogrnip" placeholder="Введите ОГРНИП..." value="{{old('ogrnip')}}">
                        ...
                        <div class="form-group @error('rs') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="rs" id="rs" placeholder="Введите расчетный счет..." value="{{old('rs')}}">
                            @if($errors->has('rs'))
                        ...
                        <div class="form-group @error('rs_name') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="rs_name" id="rs_name" placeholder="Введите наименование банка..." value="{{old('rs_name')}}">
